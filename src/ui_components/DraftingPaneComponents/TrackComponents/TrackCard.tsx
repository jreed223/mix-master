...
const TrackCard: React.FC<TrackCardProps> = (
    ...
    const displayStyle = props.displayHidden ?
...

        {
            ...
            height: isMobile ? props.tracklistArea === "search-bar-card" ? '20vw' : '15vw' : props.tracklistArea === "search-bar-card" ? '14vh' : '11vh',
            display: 'flex',
            alignItems: 'center',
                ...
                <>
                    <div onClick={props.tracklistArea !== "search-bar-card" ? () => handleCheck() : () => { }} style={{ marginLeft: "7px", cursor: props.tracklistArea !== "search-bar-card" ? 'pointer' : "default", position: "relative", display: "flex", flexDirection: "column", overflow: 'hidden', flexGrow: '1', width: "0%", height: "100%", justifyContent: 'center' }}>
                        ...
                        <div style={{ maxWidth: "100%", width: 'min-content', textWrap: 'nowrap', justifyContent: 'center' }}>
                            ...
                            {(props.trackClass.collection.type === "album" && props.trackClass.collection.albumType !== "single") &&  props.tracklistArea === "search-bar-card" ? <p className="track-card-text" style={{ fontSize: "1em", margin: "0px", color: isChecked ? "rgb(135, 135, 135, 0.35)" : "inherit" }}>{props.trackClass.collection.name}</p> : <></>}
