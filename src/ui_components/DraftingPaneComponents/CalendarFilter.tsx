...
export default function CalendarFilter(){
    ...
    const calendar = (<Calendar onChange={(date) => handleDateSelection(date)} value={dateRange} allowPartialRange selectRange={true}  tileDisabled={ filterDisabled?()=>true:({ date }) => disableFutureDates(date)}/>
    )
