...
import TracklistProvider, { TracklistContext } from "../../state_management/TracklistProvider.tsx";
import TrackClass from "../../models/TrackClass.ts";
import FilterProvider from "../../state_management/FilterProvider.tsx";
...
export default function DraftingArea({setReloadKey, setDialogText}){
    ...
    const {allTracks} = useContext(TracklistContext)
