...
switch(props.result.type){
    ...
    const displayAlbums = async ()=>{
        ...
        <div style={{height:expanded?"200px":"0px", margin: "10px",  background: "rgb(33 33 33)", overflowY:'scroll', transition:"1s"}}>
            {artistAlbumsCards}
        </div>
        </div>
    )
    ...
    const trackProps = props.result as TrackResult
        ...
        return(
            ...
            <button disabled={trackProps.isDrafted(trackProps.item.track.id)} onClick={(e)=>trackProps.draftTrack(e, trackProps.item)}></button>
