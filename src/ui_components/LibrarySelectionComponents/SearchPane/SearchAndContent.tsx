                ...
                <div style={isMobile ? { width: "100%", height: "100%", display: "flex", flexDirection: "column" } : { display: "flex", flexDirection: "column", width: "75%", minWidth: "50vw", height: "100%", margin: "auto" }}>
                    <div style={{ alignContent: "center", display: "flex", flexDirection: isMobile ? "column" : "row", margin: "auto 10px" }}>
                        <div style={{ width: "50%", display: "flex", justifyContent: "center" }}>
                            <input ref={searchInputRef} style={{ minWidth: "75%", height: "40px", color: "#878787", fontSize: "1.5em", borderRadius: "25px", paddingLeft: "15px", backgroundColor: "rgb(33 33 33)", border: "none", margin: "10px" }} type="search" placeholder="Search..." value={searchQuery} onKeyDown={(e) => { onEnter(e) }} onChange={(e) => { e.preventDefault(); setSearchQuery(e.target.value) }}></input>
                        </div>
                        <div style={{ transition: "1s", display: "inline-flex", alignItems: "center", maxWidth: searchResults ? "100%" : "0%", flex: searchResults ? "1" : "0", gap: searchResults ? "5%" : "0%", justifyContent: "center", overflow: "hidden" }}>
                            <button disabled={!searchResults || isPlaylistsView} style={{ minWidth: searchResults ? "10%" : "0%", ...visibleButton }} onKeyDown={(e) => e.preventDefault()} onClick={(e) => { e.preventDefault(); setIsPlaylistsView(true) }}>&#x1F3E0;</button>
                        ...
                        <div style={{ flex: !searchResults ? "1 1 auto " : "0 0 auto", transition: "1s",display:"flex", justifyItems:"center", alignItems:"center" }}>
